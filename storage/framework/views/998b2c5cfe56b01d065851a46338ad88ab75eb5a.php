...
<div class="well span8 offset2">
    <div class="row-fluid user-row">
        ...
        <div class="span10">
            <strong style="color:black;"><?php echo e(Auth::user()->name); ?></strong><br>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">
                    ...
                    <div class="pull-right">
                            ...
                            <button href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-danger" type="button"
                                    data-toggle="tooltip"
