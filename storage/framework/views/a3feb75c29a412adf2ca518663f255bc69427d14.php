...
<html lang="en">
	<head>
		...
		<!-- Bootstrap -->
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/css/bootstrap.min.css')); ?>"/>

		<!-- Slick -->
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/css/slick.css')); ?>"/>
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/css/slick-theme.css')); ?>"/>

		<!-- nouislider -->
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/css/nouislider.min.css')); ?>"/>
		<!-- Font Awesome Icon -->
		<link rel="stylesheet" href="<?php echo e(asset('public/css/font-awesome.min.css')); ?>">
		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('public/css/velgenstyle.css')); ?>"/>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="<?php echo e(asset('public/images/wheelsonline.png')); ?>" style="width:150px;" alt="">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
										...
										<div class="cart-list">
											<div class="product-widget">
												<div class="product-img">
													<img src="<?php echo e(asset('public/images/product01.png')); ?>" alt="">
												</div>
											...
											<div class="product-widget">
												<div class="product-img">
													<img src="<?php echo e(asset('public/images/product02.png')); ?>" alt="">
												</div>
												<div class="product-body">
													<h3 class="product-name"><a href="#">product name goes here</a></h3>
...
<!-- #region Jssor Slider Begin -->
    ...
    <script src="<?php echo e(asset('public/js/jssor.slider-27.5.0.min.js')); ?>" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<?php echo e(asset('public/images/slider/spin.svg')); ?>" />
        </div>

        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;">
            <div>
                <img data-u="image" src="<?php echo e(asset('public/images/slider/bmw1.jpg')); ?>" />
            ...
            <div>
                <img data-u="image" src="<?php echo e(asset('public/images/slider/bmw2.jpg')); ?>" />
            </div>

            <div>
                <img data-u="image" src="<?php echo e(asset('public/images/slider/bmw3.jpg')); ?>" />
    ...
    <!-- #endregion Jssor Slider End -->
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo e(asset('public/images/shop01.png')); ?>" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo e(asset('public/images/shop03.png')); ?>" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo e(asset('public/images/shop02.png')); ?>" alt="">
							</div>
							<div class="shop-body">
							...
							<div class="products-tabs">
								...
								<!-- <div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2"> -->
										<!-- product -->
										<?php $__currentLoopData = $producten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lijst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<div class="product col-md-3">
											<div class="product-img">
												<img src="<?php echo e(asset('public/images/product06.png')); ?>" alt="">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="#"><?php echo e($lijst->product_name); ?></a></h3>
												<h4 class="product-price"><?php echo e($lijst->prijs); ?><del class="product-old-price"></del></h4>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo e(asset('public/images/product07.png')); ?>" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo e(asset('public/images/product08.png')); ?>" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo e(asset('public/images/product09.png')); ?>" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo e(asset('public/images/product03.png')); ?>" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo e(asset('public/images/product04.png')); ?>" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo e(asset('public/images/product05.png')); ?>" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
		...
		<script src="<?php echo e(asset('public/js/nouislider.min.js')); ?>"></script>
