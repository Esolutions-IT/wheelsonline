    ...
    <div class="main_content">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a class="current" href="<?php echo e(route('users')); ?>">Manage Users<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                    <ul>
        ...
        <div class="center_content">
            ...
            <div class="right_content">
                ...
                <form action="<?php echo e(route('users_opslaan')); ?>" method='POST'>
                    ...
                    <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $gebruikerusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><input type="checkbox" name="" /></td>
                                <td><?php echo e($user->name); ?></td>
                                <td><?php echo e($user->email); ?></td>
                                <td><?php echo e($user->telefoon); ?></td>
                                <td><?php echo e($user->created_at); ?></td>

                                <td><a href="<?php echo e($user->user_level); ?>"><img src="<?php echo e(asset('public/images/user_edit.png')); ?>" alt="" title="" border="0" /></a></td>
